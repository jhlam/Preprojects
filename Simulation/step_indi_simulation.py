...
def update():
	...
	if(k==k_end+1):
		...
		if(n==128):
			text_file = open("step_small_indi_result_multi_run.txt", "w")
		elif(n==512):
			text_file = open("step_medium_indi_result_multi_run.txt", "w")
		else:
			text_file = open("step_large_indi_result_multi_run.txt", "w")
